...
import { SDK_VERSION, EventTypes } from '@monitor/common';
import { ReportData, InitOptions } from '@monitor/types';
...
export class TransportData {
  ...
  beacon(url: string, data: any): boolean {
    return navigator.sendBeacon(url, JSON.stringify(data)); //埋点上报的方式之一 Navigator.sendBeacon
  }
